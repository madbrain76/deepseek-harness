...
export const zh = {
  ...
  'settings.enter.description': '智能体运行时 Enter 键和发送按钮的行为；Cmd/Ctrl+Enter 使用排队或插话',
  'settings.enter.queue': '排队发送',
  'settings.enter.steer': '插话发送',
  'settings.enter.interrupt': '中断并发送',
...
export const en = {
  ...
  'input.send.interrupt': 'Interrupt and send',
  ...
  'settings.enter.description': 'What Enter and the Send button do while the agent is running; Cmd/Ctrl+Enter uses Queue or Steer',
  'settings.enter.queue': 'Queue',
  'settings.enter.steer': 'Steer',
  'settings.enter.interrupt': 'Interrupt and send',
